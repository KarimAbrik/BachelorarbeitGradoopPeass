...
public Object getObject() {
    return isBoolean() ? getBoolean() : isInt() ? getInt() : isLong() ? getLong() : isFloat() ? getFloat() : isDouble() ? getDouble() : isString() ? getString() : isBigDecimal() ? getBigDecimal() : isGradoopId() ? getGradoopId() : isMap() ? getMap() : isList() ? getList() : isDate() ? getDate() : isTime() ? getTime() : isDateTime() ? getDateTime() : null;
    ...
    "children" : [ {
      ...
      "children" : [ {
        ...
        "children" : [ {
          ...
          "otherKiekerPattern" : null,
          "module" : "gradoop-common",
          "name" : "properties.PropertyValue#validateBytesLength",
