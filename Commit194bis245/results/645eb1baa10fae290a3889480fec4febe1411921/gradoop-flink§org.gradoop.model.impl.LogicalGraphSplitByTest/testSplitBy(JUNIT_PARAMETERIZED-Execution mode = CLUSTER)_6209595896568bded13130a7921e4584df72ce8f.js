 ...
 */
public SplitBy(UnaryFunction<Vertex<Long, VD>, Long> vertexToLongFunc, final ExecutionEnvironment env) {
    this.env = env;
...
}`,"org.gradoop.model.impl.LogicalGraphSplitByTest$SplitByIdOddOrEven.execute_Vertex":
 `@Override
...
var treeData = [
{
  ...
  "children" : [ {
    ...
    "key" : "org.gradoop.model.impl.LogicalGraphSplitByTest$SplitByIdOddOrEven.execute_Vertex",
    "otherKey" : null,
    "parent" : "org.gradoop.model.impl.LogicalGraphSplitByTest#testSplitBy",
    "color" : "#FFF",
    "statistic" : null,
...
var margin = {top: 20, right: 120, bottom: 20, left: 280},
   ...
   height = 1435 - margin.top - margin.bottom;
