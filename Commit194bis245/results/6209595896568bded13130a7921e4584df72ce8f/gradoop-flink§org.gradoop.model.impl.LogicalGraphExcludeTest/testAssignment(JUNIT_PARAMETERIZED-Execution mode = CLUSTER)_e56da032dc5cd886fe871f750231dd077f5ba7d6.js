...
protected DefaultElement() {
 ...
 ``,"org.gradoop.model.helper.KeySelectors$EdgeTargetVertexKeySelector.<init>_":
...
}`,"org.gradoop.model.helper.KeySelectors$EdgeSourceVertexKeySelector.<init>_":
...
}`,"org.gradoop.model.impl.operators.Exclusion.executeInternal_LogicalGraph_LogicalGraph":
 `/**
 * {@inheritDoc}
 */
@Override
...
protected Graph<Long, VD, ED> getGellyGraph() {
    return this.graph;
}`,"org.gradoop.model.impl.LogicalGraph.exclude_LogicalGraph":
 `/**
 * {@inheritDoc}
 */
@Override
...
}`,"org.gradoop.model.impl.operators.Exclusion.<init>_":
...
var treeData = [
{
  ...
  "name" : "impl.LogicalGraphExcludeTest#testAssignment",
  ...
  "children" : [ {
    ...
    "call" : "org.gradoop.model.impl.LogicalGraph#exclude",
    "kiekerPattern" : "public org.gradoop.model.impl.LogicalGraph org.gradoop.model.impl.LogicalGraph.exclude(org.gradoop.model.impl.LogicalGraph)",
    "otherKiekerPattern" : null,
    "module" : "gradoop-flink",
    "name" : "impl.LogicalGraph#exclude",
    "key" : "org.gradoop.model.impl.LogicalGraph.exclude_LogicalGraph",
    "otherKey" : null,
    "parent" : "org.gradoop.model.impl.LogicalGraphExcludeTest#testAssignment",
    "color" : "#FFF",
    "statistic" : null,
    ...
    "children" : [ {
      ...
      "otherKey" : null,
      "parent" : "org.gradoop.model.impl.LogicalGraph#exclude",
      "color" : "#FFF",
      "statistic" : null,
      "hasSourceChange" : false,
      "state" : null,
      ...
      "call" : "org.gradoop.model.impl.operators.Exclusion#<init>",
      "kiekerPattern" : "public new org.gradoop.model.impl.operators.Exclusion.<init>()",
      "otherKiekerPattern" : null,
      "module" : "gradoop-flink",
      "name" : "impl.operators.Exclusion#<init>",
      "key" : "org.gradoop.model.impl.operators.Exclusion.<init>_",
      "otherKey" : null,
      "parent" : "org.gradoop.model.impl.LogicalGraph#exclude",
      "color" : "#FFF",
      "statistic" : null,
      ...
      "children" : [ {
        ...
        "ess" : 3,
        "children" : [ {
          "call" : "org.gradoop.model.impl.operators.Exclusion#executeInternal",
          "kiekerPattern" : "protected org.gradoop.model.impl.LogicalGraph org.gradoop.model.impl.operators.Exclusion.executeInternal(org.gradoop.model.impl.LogicalGraph,org.gradoop.model.impl.LogicalGraph)",
          "otherKiekerPattern" : null,
          "module" : "gradoop-flink",
          "name" : "impl.operators.Exclusion#executeInternal",
          "key" : "org.gradoop.model.impl.operators.Exclusion.executeInternal_LogicalGraph_LogicalGraph",
          "otherKey" : null,
          ...
          "children" : [ {
            ...
            "otherKey" : null,
            "parent" : "org.gradoop.model.impl.operators.Exclusion#executeInternal",
            "color" : "#FFF",
            "statistic" : null,
            "hasSourceChange" : false,
            "state" : null,
            ...
            "call" : "org.gradoop.model.helper.KeySelectors$EdgeSourceVertexKeySelector#<init>",
            "kiekerPattern" : "public new org.gradoop.model.helper.KeySelectors$EdgeSourceVertexKeySelector.<init>()",
            "otherKiekerPattern" : null,
            "module" : "gradoop-flink",
            "name" : "helper.KeySelectors$EdgeSourceVertexKeySelector#<init>",
            "key" : "org.gradoop.model.helper.KeySelectors$EdgeSourceVertexKeySelector.<init>_",
            "otherKey" : null,
            "parent" : "org.gradoop.model.impl.operators.Exclusion#executeInternal",
            "color" : "#FFF",
            "statistic" : null,
            ...
            "call" : "org.gradoop.model.helper.KeySelectors$EdgeTargetVertexKeySelector#<init>",
            "kiekerPattern" : "public new org.gradoop.model.helper.KeySelectors$EdgeTargetVertexKeySelector.<init>()",
            "otherKiekerPattern" : null,
            "module" : "gradoop-flink",
            "name" : "helper.KeySelectors$EdgeTargetVertexKeySelector#<init>",
            "key" : "org.gradoop.model.helper.KeySelectors$EdgeTargetVertexKeySelector.<init>_",
            "otherKey" : null,
            "parent" : "org.gradoop.model.impl.operators.Exclusion#executeInternal",
            "color" : "#FFF",
            "statistic" : null,
...
var margin = {top: 20, right: 120, bottom: 20, left: 301},
   width = 3756- margin.right - margin.left,
   height = 1505 - margin.top - margin.bottom;
